  ...
  return (
    <div className="flex w-full sm:flex-row flex-col gap-8">
      ...
      <article className="article-hover-effect p-[2rem_!important] flex-1 flex flex-col gap-5 bg-gradient-to-br from-deep-navy to-dark-slate rounded-lg">
        <h2 className="text-display text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight text-center lg:text-left bg-gradient-to-r from-primary/90 to-primary/70 bg-clip-text text-transparent">
          The Journey
        </h2>
      ...
      <article className="article-hover-effect p-[2rem_!important] flex-1 flex flex-col gap-5 bg-gradient-to-br from-deep-navy to-dark-slate rounded-lg">
        ...
        <button className="cursor-pointer tracking-wide text-lg font-bold btn-padding border-2 border-primary/50 rounded-full hover:bg-primary/80 hover:text-black hover:bg-opacity-20 transition-all btn-hover-effect self-center lg:self-start">
          Explore Discography
        </button>
      </article>
    </div>
